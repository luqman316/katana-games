    ...
    <div className="container mx-auto px-6 sm:px-10 md:px-14 py-10 min-h-screen flex flex-col lg:flex-row items-center justify-between gap-10">
      ...
      <div className="w-full lg:w-1/2 order-1 lg:order-1">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold leading-snug">
          ...
          <span>ORMING </span>
          <span className="text-5xl sm:text-6xl text-red-600">Y</span>OUR{" "}
          <span className="text-5xl sm:text-6xl text-red-600">V</span>ISION
          <br />
          <span className="text-5xl sm:text-6xl text-red-600">I</span>NTO{" "}
          <span className="text-5xl sm:text-6xl text-red-600">A</span>N{" "}
          <span className="text-5xl sm:text-6xl text-red-600">E</span>PIC{" "}
          <span className="text-5xl sm:text-6xl text-red-600">C</span>REATION
        </h1>
        ...
        <br />
        <ul className="list-disc pl-5 text-base sm:text-lg font-medium text-gray-300 space-y-1">
          <li>Game Development</li>
          <li>Blockchain Development</li>
          <li>NFT Marketplace</li>
          <li>Metaverse Development</li>
      ...
      {/* Right Section - Katana3D */}
      <div className="w-full lg:w-1/2 p-3 flex justify-center items-center order-2 lg:order-2">
        <Katana3D />
      </div>
    </div>
  );
